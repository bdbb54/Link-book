<html>
    <head>
        <title>Linkbook &mdash; Registration</title>
    </head>
<body>
        <script>
...
<?php
    if(isset($_POST['submit'])) {
        ...
        if( accountExists() ) {
          ...
          $link = mysqli_connect("us-cdbr-azure-central-a.cloudapp.net","b3915776efe984","924ab3fb","cs3380-pickchamp") or die ("Connection Error " . mysqli_error($link));				
